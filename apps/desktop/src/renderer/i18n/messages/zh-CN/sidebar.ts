...
export const sidebar: CatalogFor<SidebarMessages> = {
  ...
  'sidebar.saved': '已保存',
  'sidebar.saved.connect': '连接',
  'sidebar.saved.open': '已打开',
  'sidebar.saved.edit': '编辑',
  'sidebar.saved.forget': '删除',
  'sidebar.saved.forgetConfirm': '确认删除？',
  'sidebar.saved.withSecret': '密码已存入系统钥匙串',
  'sidebar.saved.noSecret': '未保存密码',
