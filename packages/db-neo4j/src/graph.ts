 ...
 * package host, reached through `@peek/db-neo4j/view`, because that is where
...
/**
 * Read a package view's opaque state into this view's shape.
 *
 ...
 * package's own frame. This function is the one boundary where it becomes typed,
