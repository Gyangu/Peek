 ...
 *
 * The same rule as driver-postgres's sql.ts, restated because it is the one thing
 ...
 * of the next page as a decimal string — exactly what driver-postgres does, so
 ...
 *
 * driver-postgres aliases the derived table's columns positionally
